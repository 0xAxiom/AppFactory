 ...
 */
export type PipelineId = 'app-factory' | 'dapp-factory' | 'agent-factory' | 'plugin-factory' | 'miniapp-pipeline' | 'website-pipeline';
/**
 * Pipeline execution status
 */
export type PipelineStatus = 'pending' | 'in_progress' | 'completed' | 'failed' | 'paused';
/**
