 ...
 */
export declare function loadPipelineConfig(
  configPath: string
 ...
 * @returns Configuration load result
 */
export declare function loadRalphConfig(
  configPath: string
 ...
 * @returns Configuration load result
 */
export declare function loadValidationConfig(
  configPath: string
 ...
 * @returns Configuration load result
 */
export declare function loadPipelineConfigFile(
  configPath: string
 ...
 * @returns Configuration load result
 */
export declare function discoverPipelineConfig(
  pipelineDir: string
