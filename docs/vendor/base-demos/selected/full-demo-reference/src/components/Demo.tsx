...
export default function Demo() {
  ...
  const actionDefinitions: ActionDefinition[] = [
    ...
    {
      id: 'setprimarybutton',
      name: 'Set Primary Button',
      description: 'Configure primary button',
      component: SetPrimaryButtonAction,
    },
    {
      id: 'haptics',
      name: 'Haptics',
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="font-semibold text-foreground">
                    {
                      actionDefinitions.find((a) => a.id === currentActionPage)
                        ?.name
                    }
                  </h2>
                </div>
                <div className="border border-border rounded-lg p-4 bg-white">
                  {currentActionPage === 'runtime' ? (
                    ...
                    (() => {
                      const ActionComponent = actionDefinitions.find(
                        (a) => a.id === currentActionPage
                      )?.component;
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-white border border-border rounded-lg">
                <span className="font-mono text-sm text-primary font-medium">
                  {frameContext
                    ? (frameContext.isInMiniApp ?? false).toString()
                    : 'false'}
                </span>
              </div>
            </div>
            ...
            {frameContext?.context && (
              <div className="space-y-3">
                {Object.entries(
                  frameContext.context as Record<string, unknown>
                ).map(([key, value]) => (
                  <div key={key}>
