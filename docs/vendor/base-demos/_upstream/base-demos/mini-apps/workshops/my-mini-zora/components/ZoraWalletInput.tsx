  ...
  return (
    <div className="fixed inset-0  flex items-center justify-center bg-black">
      <div className="w-full max-w-md relative">
        <div
          className={`border ${isFocused ? "border-lime-700/70" : "border-lime-700/40"} bg-black p-8 relative mx-4 transition-colors duration-300`}
        >
          <h2 className="text-3xl font-bold text-white mb-8 text-center font-mono">
            {displayName ? (
              ...
              <span className="break-words">
                ENTER YOUR ZORA HANDLE TO START
              </span>
            )}
          </h2>
