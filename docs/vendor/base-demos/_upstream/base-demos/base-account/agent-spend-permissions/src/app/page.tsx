          ...
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-gray-600">
                Buy any creator coin with your Base Account
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  Sign in with your Base Account
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  Configure your daily spend permissions ($1-$2)
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  Chat with the agent to buy Zora creator coins
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="ml-6 flex-1">
                    ...
                    <p className="text-gray-600">
                      Signs in with Base Account and grants spend permission to
                      server wallet
                    </p>
                  </div>
                  <div className="hidden md:block">
                    <svg
                      className="w-8 h-8 text-gray-300 group-hover:text-blue-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                      <path
                        ...
                        strokeWidth="2"
                        d="M19 14l-7 7m0 0l-7-7m0 0l7-7"
                      />
                    </svg>
                  </div>
                </a>
                ...
                >
                  ...
                  <div className="ml-6 flex-1">
                    ...
                    <p className="text-gray-600">
                      Prepares spend permission calls and sends to backend
                    </p>
                  </div>
                  <div className="hidden md:block">
                    <svg
                      className="w-8 h-8 text-gray-300 group-hover:text-purple-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                >
                  ...
                  <div className="ml-6 flex-1">
                    ...
                    <p className="text-gray-600">
                      Processes natural language requests and decides to buy
                      creator coins
                    </p>
                  </div>
                  <div className="hidden md:block">
                    <svg
                      className="w-8 h-8 text-gray-300 group-hover:text-green-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                >
                  ...
                  <div className="ml-6 flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-orange-600">
                      Server Wallet (CDP Smart Account)
                    </h3>
                    <p className="text-gray-600">
                      Executes spend calls, swaps USDC for creator coins,
                      transfers to user
                    </p>
                  </div>
                  <div className="hidden md:block">
                    <svg
                      className="w-8 h-8 text-gray-300 group-hover:text-orange-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                >
                  ...
                  <div className="ml-6 flex-1">
                    ...
                    <p className="text-gray-600">
                      Creator coin lookup and trading via Zora's decentralized
                      protocol
                    </p>
                  </div>
                  <div className="hidden md:block">
                ...
                >
                  ...
                  <div className="ml-6 flex-1">
                    ...
                    <p className="text-gray-600">
                      Transactions execute on-chain with gas sponsorship
                    </p>
                  </div>
                </a>
              </div>
              ...
              <div className="mt-12 grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    User grants limited spending authority to server wallet's
                    smart account. Server can only spend up to the permitted
                    amount.
                  </p>
                </a>
                <a
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    All transactions are sponsored using CDP's paymaster. Users
                    don't need ETH for gas fees.
                  </p>
                </a>
              </div>
            </div>
