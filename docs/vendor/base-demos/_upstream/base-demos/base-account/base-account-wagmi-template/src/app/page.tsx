      ...
      <div style={styles.innerContainer}>
            ...
            <div style={styles.accountInfo}>
              <div style={styles.infoRow}>
                ...
                <code style={styles.infoValue}>
                  {account.addresses?.[0] ? `${account.addresses[0]}` : 'N/A'}
                </code>
              </div>
            </div>
            <button
        ...
        {account.status !== 'connected' && (
          <div style={styles.card}>
            ...
            {error && <div style={styles.errorMessage}>⚠️ {error.message}</div>}
          </div>
        )}
        ...
        <footer style={styles.footer}>
          <p style={styles.footerText}>Powered by Base • Built with Wagmi</p>
        </footer>
      </div>
    </div>
  );
