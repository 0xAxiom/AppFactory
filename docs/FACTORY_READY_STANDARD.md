...
Every project built by an App Factory pipeline must pass this standard before it can be deployed or launched on the Factory launchpad.
...
| **web3-factory** | Push to GitHub | Repository ready for launchpad import |
| **agent-factory** | Push to GitHub | Repository ready for launchpad import |

### Pass Criteria
- [ ] Code pushed to GitHub repository
- [ ] Repository is accessible (public or launchpad has access)
...
- Private repo without launchpad access
...
| `FACTORY_IMPORT.md` | How to import/launch on launchpad | Yes |
...
- [ ] FACTORY_IMPORT has upload URL and steps
...
```json
{
  ...
  "next_steps": [
    "Push to GitHub",
    "Import on factoryapp.dev (Repo Mode)",
