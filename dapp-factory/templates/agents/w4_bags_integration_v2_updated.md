...
```json
{
  ...
  "required": ["app_configuration", "environment_config", "program_ids", "file_upload_config", "idempotency_config"]
}
```
...
const socialClaimersBPS = w2Data.fee_share_configuration.social_fee_claimers.reduce(
